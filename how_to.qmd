...
::: {.callout-important}
The function downloads the material that has been posted up to that point. For each session, the function must be run again to get the new material for the new sessions.
:::
